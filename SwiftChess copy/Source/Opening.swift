...
public class Opening {
    ...
    static public func allOpenings() -> [Opening] {
        return [
            RuyLopez(),
            ItalianGame(),
            SicilianDefense(),
    ...
    static func allOpeningMoves(for color: ChessColor) -> [OpeningMove] {
    ...
    public func moves(for color: ChessColor) -> [OpeningMove] {
    ...
    public func moveGridPositions() -> [(fromPosition: BoardLocation.GridPosition, toPosition: BoardLocation.GridPosition)] {
...
public class RuyLopez: Opening {
    
    override public func moveGridPositions() ->
