...
public final class AIPlayer: Player {
    ...
    public init(color: ChessColor, configuration: AIConfiguration) {
...
extension AIPlayer: DictionaryRepresentable {
    ...
    convenience init?(dictionary: [String: Any]) {
        ...
        guard
            ...
            let color = ChessColor(rawValue: colorRaw),
...
struct Move {
    ...
    enum MoveType {
        ...
        case castle(color: ChessColor, side: CastleSide)
    }
...
internal class BoardRater {
    ...
    func ratingFor(board: Board, color: ChessColor) -> Double {
