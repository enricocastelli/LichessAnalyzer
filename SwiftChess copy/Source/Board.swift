...
public struct Board: Equatable {
    ...
    mutating func setupForNewGame() {
        ...
        func makePiece(type: Piece.PieceType, color: ChessColor) -> Piece {
    ...
    @discardableResult internal mutating func movePiece(from fromLocation: BoardLocation,
                                                        to toLocation: BoardLocation, delay: Double? = nil) -> [BoardOperation] {
    ...
    func getKing(color: ChessColor) -> Piece {
    ...
    public func getKingLocation(color: ChessColor) -> BoardLocation {
    ...
    public func getLocations(of color: ChessColor) -> [BoardLocation] {
    ...
    public func getPieces(color: ChessColor) -> [Piece] {
    ...
    public func getLocationsOfPromotablePawns(color: ChessColor) -> [BoardLocation] {
    ...
    public func isColorInCheck(color: ChessColor) -> Bool {
    ...
    public func isColorInCheckMate(color: ChessColor) -> Bool {
    ...
    public func isColorInStalemate(color: ChessColor) -> Bool {
    ...
    func isColorAbleToMove(color: ChessColor) -> Bool {
    ...
    func canColorMoveAnyPieceToLocation(color: ChessColor, location: BoardLocation) -> Bool {
    ...
    func doesColorOccupyLocation(color: ChessColor, location: BoardLocation) -> Bool {
    ...
    struct CastleMove {
        ...
        init(color: ChessColor, side: CastleSide) {
    ...
    public func canColorCastle(color: ChessColor, side: CastleSide) -> Bool {
    ...
    @discardableResult internal mutating func performCastle(color: ChessColor, side: CastleSide) -> [BoardOperation] {
